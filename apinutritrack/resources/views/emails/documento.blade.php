                        ...
                        <td align="center">
                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td align="center" background="https://expediente.nutricion.co.cr/email/images/title-bg.png" style="background-image: url(https://expediente.nutricion.co.cr/email/images/title-bg.png); background-repeat: repeat-x; background-size: auto; background-position: bottom;">
                                  ...
                                  <tr>
                                    <td height="50" align="center">
                                      <table border="0" align="center" cellpadding="0" cellspacing="0" class="table-inner">
                                        ...
                                        <tr>
                                          <td align="center" style="font-family: 'Open sans', Arial, sans-serif; color:#FFFFFF; font-size:16px; font-weight: bold;">{{ $titulo }}</td>
                                        </tr>
                                        <tr>
                                          <td height="7"></td>
                                        </tr>
                          ...
                          <table align="center" class="table-inner" width="90%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td align="center" style="font-family: 'Open sans', Arial, sans-serif; color:#7f8c8d; font-size:14px; line-height: 28px;">
                                {{ $nombre_persona }}, ha recibido la {{ $tipo_doc }} : N° {{ $numeracion }} de la cuenta de {{ $nombre_nutricionista }}. Puede verla y descargarla del siguiente enlace
                                 <br/> 
                                <a href="{{ $pdf }}" target="_blank">click aquí para ver la factura</a>
                              </td>
                            </tr>
                            <!--end content-->
                            <tr>
