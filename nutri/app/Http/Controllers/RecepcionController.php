 ...
 */
		...
		/*$_json['api_key']	=	'-dYSrMCCTX0';/*$nutricionista->token;*/
...
fecha	null
	...
	*/
			...
			$response['stored']	=	Recepcion::create( $doc_recibido );

		} catch(Illuminate\Database\QueryException $e) {
			dd($e);			
			$response['error_query']	=	$e;
		} catch(PDOException $e) {
			dd($e);
			$response['error_pdo']	=	$e;
		}
