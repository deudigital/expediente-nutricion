                                  ...
                                  <tr>
                                    <td height="50" align="center">
                                      <table border="0" align="center" cellpadding="0" cellspacing="0" class="table-inner">
                                        ...
                                        <tr>
                                          <td align="center" style="font-family: 'Open sans', Arial, sans-serif; color:#FFFFFF; font-size:16px; font-weight: bold;">Cita agendada</td>
                                        </tr>
                                        <tr>
                                          <td height="7"></td>
                                        </tr>
                      ...
                      <tr>
                        <td bgcolor="#f3f3f3" align="center">
                          <table align="center" class="table-inner" width="90%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <!--headline-->
                            <tr>
                              <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:22px;color:#414a51;font-weight: bold;letter-spacing: 2px;">¡Nos vemos pronto! &#x1F60A;</td>
                            </tr>
                            <!--end headline-->
                            <tr>
                              <td height="25"></td>
                            ...
                            <tr>
                              <td align="center" style="font-family: 'Open sans', Arial, sans-serif; color:#7f8c8d; font-size:14px; line-height: 28px;">
								{{ $nombre_paciente }}, tu cita <strong>el {{ $dia_de_la_semana }} {{ $dia }} de {{ $mes_en_letras }}, {{ $aaaa }} a las {{ $hhmm }}{{ $ampm }}</strong> ha sido agendada.<br/><br/><strong>{{ $nombre_nutricionista }}</strong>
                              </td>
                            </tr>
                            <!--end content-->
                            <tr>
