...
use App\Models\BioquimicaClinica;
use App\Models\HcpOtro;
use App\Models\HcfPatologiasPaciente;
use App\Models\PatologiasPaciente;
use App\Models\AlergiasPaciente;
use App\Models\HabitosGusto;
use App\Models\HabitosOtro;
use App\Models\EjerciciosPaciente;
	...
	public function updateContrasena(Request $request){
		...
		if($paciente){
			...
			Mail::send('emails.contrasena_cambiada', $data, function($message) use ($paciente) {
				...
				$subject	=	$paciente->nombre . utf8_encode(', tu contrase�a ha sido cambiada');
