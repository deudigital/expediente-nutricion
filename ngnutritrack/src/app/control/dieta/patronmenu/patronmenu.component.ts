...
export class PatronmenuComponent implements OnInit {
  ...
  ngOnInit() {
	...
	setInfoInit(){/*console.log('setInfoInit');*/
  ...
  concatenar(aMenu){
   ...
   tabSelected(tab:string){
	...
	Next(){
		...
		/*if(this.model.current_dieta.dieta_id==this.model.dietas[this.model.dietas.length-1].dieta_id){*/
		...
		for(var i =0;i<this.model.dietas.length-1;i++){
			/*if(this.model.current_dieta.dieta_id==this.model.dietas[i].dieta_id){*/
