...
<body style="background:url('https://expediente.nutricion.co.cr/bg-login@2x.6c503c7d8db2c72eaf47.jpg') no-repeat center center #414a51;background-size:cover;">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td align="center">
        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center" bgcolor="" background="" style="">
                      ...
                      <tr>
                        <td bgcolor="#f3f3f3" align="center">
                          <table align="center" class="table-inner" width="90%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <!--headline-->
                            <tr>
                              <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:22px;color:#414a51;font-weight: bold;letter-spacing: 2px;">Recordatorio de Citas</td>
                            </tr>
                            <!--end headline-->
                            <tr>
                              <td height="25"></td>
...
<pre>Nutricionistas con citas:	{{$nutricionista_count}}</pre>
<pre>Notificaciones enviadas:	{{$emails_notificatified}}</pre>

@isset($status_email)
<h3>Resumen de envio por agenda [ ID, estado del envio del correo ]</h3>
<ul>
