                                  ...
                                  <tr>
                                    <td height="50" align="center">
                                      <table border="0" align="center" cellpadding="0" cellspacing="0" class="table-inner">
                                        ...
                                        <tr>
                                          <td align="center" style="font-family: 'Open sans', Arial, sans-serif; color:#FFFFFF; font-size:16px; font-weight: bold;">Recordatorio contraseña</td>
                                        </tr>
                                        <tr>
                                          <td height="7"></td>
                                        </tr>
                        ...
                        <td bgcolor="#f3f3f3" align="center">
                          <table align="center" class="table-inner" width="90%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
							  ...
							  {{ $nombre }}, su usuario para ingresar al app es <strong>{{ $usuario }}</strong> y su contraseña es <strong>{{ $contrasena }}</strong>  &#x1F603;
                              </td>
                            </tr>
                            <!--end content-->
                            <tr>
